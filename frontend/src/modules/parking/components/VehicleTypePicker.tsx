          ...
          <button
            ...
            className={`flex flex-col items-center gap-1.5 py-2.5 px-1 rounded-2xl border transition-all cursor-pointer group ${
              isActive
                ...
                : isSupported
                  ? "bg-white dark:bg-[#0B192C] border-gray-200 dark:border-slate-700 text-slate-700 dark:text-gray-200 hover:border-[#F28C28] hover:bg-blue-50/60 dark:hover:bg-slate-800"
            ...
            <span
              className={`p-1.5 rounded-xl transition-colors ${
                isActive
                  ...
                  : isSupported
                    ? "bg-blue-50 dark:bg-blue-900/30 text-[#F28C28] dark:text-amber-300 group-hover:bg-[#F28C28] group-hover:text-white"
