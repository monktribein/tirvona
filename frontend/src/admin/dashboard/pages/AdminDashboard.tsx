...
export const AdminDashboard: React.FC = () => {
  ...
  const [approvalTab, setApprovalTab] = useState<
    "ashrams" | "owners" | "banners" | "blogs" | "offers"
  >("banners");
  ...
  const handleRejectCms = async (id: string) => {
    try {
      const res = await api.post(`/cms/reject/${id}`, {
        reason: "Does not align with trust guidelines",
      });
      if (res.data?.success) {
        addNotification(
          "Request Rejected",
          "Feedback sent back to BannerBoy.",
          "warning",
        );
        fetchPendingCmsRequests();
      }
  ...
  const activeHubDetails =
    spiritualHubs.find((h) => h.name === selectedHub) || spiritualHubs[0];
    ...
    <div className="space-y-8 text-left max-w-7xl mx-auto pb-12">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <span className="px-3.5 py-1 bg-[#E58C28]/20 text-[#E58C28] rounded-full text-[10px] font-black uppercase tracking-wider border border-[#E58C28]/35 flex items-center gap-1.5 shadow-sm">
                ...
                Digital India Spiritual Engine
              </span>
            ...
            <h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight">
              {getGreeting()}, National Administrator{" "}
              <span className="align-middle">🙏</span>
            </h1>
            <p className="text-xs sm:text-sm text-blue-100/90 font-medium max-w-xl leading-relaxed">
              Welcome back,{" "}
              <strong className="text-[#E58C28] font-bold">
                {user?.name || "Administrator"}
              </strong>{" "}
              ({user?.role?.replace("_", " ").toUpperCase()}). Overview of
              national ashram onboarding, verification queues, and live pilgrim
              telemetry.
            </p>
          </div>
        ...
        {[
          {
            ...
            value: stats?.ashrams?.approved || "1,248",
            tag: "ACTIVE RETREATS",
            change: "+12.4%",
            isPos: true,
          ...
          },
          {
            ...
            value: stats?.ashrams?.pending || "34",
            tag: "AUDIT QUEUE",
            change: "-5.2%",
            isPos: true,
            icon: <FileCheck size={20} className="text-[#0A4DA6]" />,
            bg: "bg-[#0A4DA6]/10",
          },
          {
            label: "Rejected Listings",
            value: stats?.ashrams?.rejected || "12",
            tag: "NON-COMPLIANT",
            change: "-2.1%",
            isPos: false,
          ...
          },
          {
            ...
            change: "+18.7%",
            isPos: true,
            icon: <CalendarIcon size={20} className="text-[#E58C28]" />,
            bg: "bg-[#E58C28]/10",
          },
          {
            label: "Revenue Today",
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div>
            ...
            <p className="text-xs text-blue-100/80 mt-0.5 max-w-xl">
              All structural ashram, room category, pricing, gallery, offer, and
              marketplace approval requests are centralized in a single workflow
              console.
            </p>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-[28px] p-6 shadow-lg shadow-gray-200/40 space-y-4 text-center">
        <div className="space-y-1">
          <span className="text-[#E58C28] font-bold text-xs uppercase tracking-wider block">
            Spiritual Circuits & Coverage
          </span>
          <h2 className="text-2xl font-black text-[#0B192C] dark:text-white tracking-tight">
            Explore Sacred{" "}
            <span className="bg-[#0A4DA6] text-white px-3.5 py-0.5 rounded-full inline-block font-black text-lg mx-1">
              Destinations
            </span>{" "}
            Telemetry
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 pt-2">
          {spiritualHubs.map((hub) => (
            ...
            >
              <div
                className={`p-2 rounded-xl ${selectedHub === hub.name ? "bg-white/20 text-white" : "bg-gray-200/60 dark:bg-slate-800 text-[#0A4DA6]"}`}
              >
                {hub.icon}
              </div>
        ...
        <div className="bg-gradient-to-r from-gray-50 to-blue-50/40 dark:from-slate-900 dark:to-slate-850 p-5 rounded-2xl border border-gray-150 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-4 gap-4 text-xs text-left mt-4">
          <div className="space-y-1">
            ...
            <p className="font-extrabold text-[#0B192C] dark:text-white text-sm">
              {activeHubDetails.name}
            </p>
            <span className="text-gray-400 text-[10px]">
              {activeHubDetails.district}, {activeHubDetails.state}
            </span>
          </div>
          <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <p className="text-2xl font-black text-[#0A4DA6]">
              {activeHubDetails.pending}
            </p>
          </div>
          <div className="space-y-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-[28px] p-6 shadow-lg shadow-gray-200/40 space-y-6">
            <div className="flex justify-between items-center border-b border-gray-100 dark:border-slate-800 pb-4">
              <div>
                <h3 className="font-extrabold text-base text-[#0B192C] dark:text-white flex items-center gap-2">
                  <TrendingUp size={18} className="text-[#0A4DA6]" /> National
                  Pilgrim Booking & Revenue Telemetry
                </h3>
                <p className="text-xs text-gray-400 font-semibold">
                  Monthly Yatra booking density vs verified stay compliance
                </p>
              </div>
            ...
            <div className="space-y-4">
              {[
                {
                  month: "Apr (Chaitra Yatra)",
                  bookings: 840,
                  revenue: "₹84.2 Lakh",
                  pct: 85,
                },
                {
                  month: "May (Char Dham Open)",
                  bookings: 980,
                  revenue: "₹98.5 Lakh",
                  pct: 98,
                },
                {
                  month: "Jun (Hemkund Sahib Peak)",
                  bookings: 760,
                  revenue: "₹76.0 Lakh",
                  pct: 76,
                },
                {
                  month: "Jul (Current Sravan Yatra)",
                  bookings: 920,
                  revenue: "₹92.4 Lakh",
                  pct: 92,
                },
                ...
                <div key={i} className="space-y-1.5">
                  <div className="flex justify-between text-xs font-bold text-[#0B192C] dark:text-gray-200">
                    <span>{m.month}</span>
                    <span className="font-black text-[#0A4DA6]">
                      {m.bookings} Bookings ({m.revenue})
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-gray-100 dark:border-slate-800 text-xs">
              <div className="p-3.5 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 space-y-1">
                ...
                <p className="font-extrabold text-[#0B192C] dark:text-white">
                  142,500 Unique Visits
                </p>
              </div>
              <div className="p-3.5 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 space-y-1">
                <span className="text-[10px] text-gray-400 font-bold uppercase">
              ...
              <div className="p-3.5 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 space-y-1">
                ...
                <p className="font-extrabold text-[#E58C28]">
                  82% Pilgrims • 18% Trusts
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-[28px] p-6 shadow-lg shadow-gray-200/40 space-y-5">
            <div className="flex justify-between items-center border-b border-gray-100 dark:border-slate-800 pb-3">
              <h3 className="font-extrabold text-base text-[#0B192C] dark:text-white flex items-center gap-2">
                <LayersIcon size={18} className="text-[#0A4DA6]" /> Central
                Approval & Audit Queue
              </h3>
              <div className="flex gap-1.5">
                {[
                  {
                    id: "banners",
                    label: `Banners (${pendingCmsRequests.length})`,
                  },
            ...
            <div className="space-y-3">
              {approvalTab === "banners" ? (
                ...
                [
                  {
                    name: "Parmarth Niketan Branch #2 (Rishikesh)",
                    owner: "Nakul Jain",
                    submitted: "2 hours ago",
                    code: "ASH-8812",
                  },
                  {
                    name: "Ganga Kripa Dharamshala (Haridwar)",
                    owner: "Swami Vidyanand",
                    submitted: "4 hours ago",
                    code: "ASH-8814",
                  },
                  {
                    name: "Shree Krishna Retreat (Vrindavan)",
                    owner: "Radha Trust Board",
                  ...
                  <div
                    key={i}
                    className="p-4 bg-gray-50 dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-850 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
                  >
                    <div className="space-y-0.5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded text-[9px] font-bold">
                          {item.code}
                        </span>
                      </div>
                      <p className="text-gray-400">
                        Applicant: {item.owner} • Submitted {item.submitted}
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                      <button
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2.5 text-xs">
              {[
                ...
                },
                {
                  ...
                  status: "Healthy",
                  ping: "45ms",
                  icon: <HardDrive size={14} className="text-emerald-500" />,
                },
                {
                  name: "SMS Gateway (NIC India)",
                  status: "Healthy",
                  ping: "110ms",
                  icon: <Radio size={14} className="text-emerald-500" />,
                },
                {
                  name: "CPU Load (Cloud Server)",
                  status: "18% Utilized",
                  ping: "Healthy",
                ...
                <div
                  key={i}
                  className="flex justify-between items-center p-2.5 bg-gray-50 dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-850"
                >
                  <div className="flex items-center gap-2">
                    {sys.icon}
                    <span className="font-bold text-[#0B192C] dark:text-gray-200">
                      {sys.name}
                    </span>
                  </div>
          ...
          <div className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-[28px] p-6 shadow-lg shadow-gray-200/40 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              <div className="p-3.5 bg-amber-50 dark:bg-amber-950/30 rounded-2xl border border-amber-100 dark:border-amber-900/40">
                <span className="text-[10px] text-[#E58C28] font-bold uppercase">
                  Suspended Accounts
                </span>
          ...
          <div className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-[28px] p-6 shadow-lg shadow-gray-200/40 space-y-4">
            <h3 className="font-extrabold text-sm text-[#0B192C] dark:text-white flex items-center gap-2 border-b border-gray-100 dark:border-slate-800 pb-3">
              <Clock size={16} className="text-[#0A4DA6]" /> Live Audit Stream
              Timeline
            </h3>
              ...
              {[
                {
                  ...
                  user: "Nakul Jain",
                  role: "Owner",
                  desc: "Registered Parmarth Ashram #2 (Rishikesh)",
                },
                {
                  time: "09:50 AM",
                  user: "District Magistrate",
                  role: "Govt Admin",
                  desc: "Approved Ganga Kripa inspection",
                },
                {
                  time: "09:12 AM",
                  user: "Super Admin",
                  role: "Super Admin",
                  desc: "Updated Sravan Yatra Banner Slider",
                },
                {
                  time: "08:45 AM",
                  user: "System Bot",
                  role: "Automated",
                  desc: "Reactivated 2 expired temp suspended users",
                },
              ].map((act, i) => (
                <div
                  key={i}
                  className="flex gap-3 items-start border-l-2 border-[#0A4DA6] pl-3 py-1"
                >
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      <span className="font-extrabold text-[#0B192C] dark:text-white">
