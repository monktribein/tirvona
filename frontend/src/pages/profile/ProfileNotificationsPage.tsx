...
import { ArrowLeft, CheckCircle2, Tag, Calendar } from "lucide-react";
...
export const ProfileNotificationsPage: React.FC = () => {
  const notificationsList = [
    ...
    {
      title: "Special Festival Coupon",
      desc: "Use code YATRA20 to get 20% OFF on all Rishikesh spiritual stays.",
      time: "1 day ago",
      icon: <Tag className="text-amber-500" size={16} />,
    },
    {
      title: "System Security Notice",
      desc: "Your Tirvona Yatri Profile login was verified from a new device.",
      time: "3 days ago",
      ...
      <section className="bg-gradient-to-r from-[#0B192C] via-[#0A4DA6] to-[#0B192C] text-white pt-10 pb-16 px-4 sm:px-6 lg:px-8 border-b border-white/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-3 relative z-10">
          ...
          <p className="text-xs text-blue-100/80 font-medium">
            Booking alerts, festival announcements, and security updates.
          </p>
        </div>
      </section>
            ...
            {notificationsList.map((n, idx) => (
              <div key={idx} className="py-4 flex items-start gap-4 text-xs">
                ...
                <div className="space-y-1">
                  <h4 className="font-extrabold text-[#0B192C] dark:text-white">
                    {n.title}
                  </h4>
