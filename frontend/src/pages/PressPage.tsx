...
const pressReleases = [
  {
    date: "July 2025",
    title: "Tirvona Surpasses 10 Million Pilgrim Registrations Across India",
    tag: "Milestone",
  },
  {
    date: "June 2025",
    title:
      "Ministry of Tourism Recognises Tirvona as Digital India Champion 2025",
    tag: "Award",
  },
  {
    date: "May 2025",
    title: "Tirvona AI Pilgrim Assistant Now Available in 12 Indian Languages",
    tag: "Product",
  },
  {
    date: "March 2025",
    title:
      "Tirvona Raises Series A Funding to Expand Across South India and Northeast",
    tag: "Funding",
  },
  {
    date: "Jan 2025",
    title: "Tirvona Signs MoU with Uttarakhand Tourism Development Board",
    tag: "Partnership",
  },
  {
    date: "Nov 2024",
...
const coverage = [
  {
    ...
    logo: "🗞️",
    quote:
      '"Tirvona is redefining how India\'s millions of pilgrims find safe and verified accommodation."',
  },
  {
    outlet: "Economic Times",
    logo: "📰",
    quote:
      "\"A tech-first approach to India's ancient tradition of sacred travel — and it's working.\"",
  },
  {
    outlet: "NDTV",
    logo: "📺",
    quote:
      '"With government backing and AI-powered guidance, Tirvona is the future of spiritual tourism."',
  },
];
    ...
    <section className="bg-[#0B192C] text-white py-16 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            href="mailto:press@tirvona.in"
            className="inline-flex items-center gap-2 min-h-[48px] px-6 py-2.5 bg-[#D4AF37] text-[#0B192C] font-extrabold text-sm rounded-full"
          >
            <Mail size={14} /> Contact Press Team
          </a>
          <a
            href="#"
            className="inline-flex items-center gap-2 min-h-[48px] px-6 py-2.5 bg-white/10 border border-white/20 text-white font-extrabold text-sm rounded-full"
          >
    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-6 py-14 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        {coverage.map((c, i) => (
          <div
            key={i}
            className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-sm"
          >
    ...
    <section className="max-w-4xl mx-auto px-4 sm:px-6 pb-14 space-y-6">
      ...
      <div className="space-y-3">
        {pressReleases.map((pr, i) => (
          <div
            key={i}
            className="bg-white dark:bg-[#0B192C] border border-gray-100 dark:border-slate-800 rounded-2xl p-5 flex items-start justify-between gap-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer group"
          >
    ...
    <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-14">
      <div className="bg-[#0B192C] text-white rounded-3xl p-8 text-center space-y-4 relative overflow-hidden">
        ...
        <p className="text-sm text-gray-300 relative z-10">
          For press interviews, fact-checking, or brand assets, reach out to our
          communications team.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center relative z-10">
          <a
            href="mailto:press@tirvona.in"
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-6 py-2 bg-[#D4AF37] text-[#0B192C] font-extrabold text-sm rounded-full"
          >
            press@tirvona.in
          </a>
        </div>
