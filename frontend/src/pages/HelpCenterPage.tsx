...
const getCategories = () => [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Absolutely. All transactions are processed via RazorPay with 256-bit SSL encryption. We are PCI-DSS compliant and your card details are never stored on our servers.",
      },
      {
        q: "When will I get my refund?",
        a: "Approved refunds are credited within 5–7 business days to your original payment method. For UPI payments, refunds typically arrive in 1–2 business days.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: "Is my personal data safe with Tirvona?",
        a: "Yes. We are compliant with India's Digital Personal Data Protection Act 2023. We never sell your data to third parties. See our Privacy Policy for complete details.",
      },
      {
        q: "How do I delete my account?",
        a: 'Go to Dashboard → Settings → Account → "Delete Account". All personal data will be permanently removed within 30 days as per our data retention policy.',
      },
      {
        q: "I forgot my password. How do I reset it?",
        a: "Click \"Forgot Password\" on the login page. Enter your registered email and you'll receive a reset link valid for 30 minutes. If you don't receive it, check your spam folder or contact support.",
      },
    ],
  },
];
                ...
                {cat.items.map((item, ii) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="font-semibold text-sm text-[#0B192C] dark:text-white">
                          {item.q}
                        </span>
                        {openItem === key ? (
                          <ChevronUp
      ...
      <section className="max-w-2xl mx-auto px-4 sm:px-6 pb-14">
        <div className="bg-[#0A4DA6] text-white rounded-3xl p-8 text-center space-y-4">
          ...
          <p className="text-sm text-blue-100">
            Our support team is available 24/7. We typically respond within 2
            hours.
          </p>
