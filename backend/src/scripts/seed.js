...
const seedData = async (users) => {
  ...
  const ashramConfigs = [
    // === HARIDWAR (5 Ashrams) ===
    {
      ...
      images: [
        '/images/shantikunj/cover.jpg',
        '/images/shantikunj/temple.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/prem_nagar/cover.jpg',
        '/images/prem_nagar/garden.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/bharat_sevashram/cover.jpg',
        '/images/bharat_sevashram/hall.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/maa_anandamayi/cover.jpg',
        '/images/maa_anandamayi/samadhi.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/sapt_rishi/cover.jpg',
        '/images/sapt_rishi/river.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/swami_dayananda/cover.jpg',
        '/images/swami_dayananda/canal.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/omkarananda/cover.jpg',
        '/images/omkarananda/ashram.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/gita_bhawan/cover.jpg',
        '/images/gita_bhawan/ghat.jpg'
      ],
    ...
    // === VRINDAVAN (5 Ashrams) ===
    {
      ...
      images: [
        '/images/iskcon_vrindavan/cover.jpg',
        '/images/iskcon_vrindavan/samadhi.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/mvt_vrindavan/cover.jpg',
        '/images/mvt_vrindavan/garden.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/prem_mandir_jkp/dharamshala.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/fogla_ashram/cover.jpg',
        '/images/fogla_ashram/courtyard.jpg'
      ],
    ...
    },
    {
      ...
      images: [
        '/images/bhagwat_dham/cover.jpg',
        '/images/bhagwat_dham/ashram.jpg'
      ],
